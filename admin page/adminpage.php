...
<body>
    ...
    <nav class="navbar">
        <div class="nav-container">
            <a href="#home" class="logo">
                <div class="logo-icon"><img src="http://localhost/project/Images for website/homepage/img.png" width="65px" height="65px" alt="icon.png"></div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-actions">
                                            ...
                                            <form method="POST" action="http://localhost/project/admin_doctor_CRUD/admin_doctor_delete.php" style="display:inline;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-actions">
                                            ...
                                            <form method="POST" action="http://localhost/project/admin_patient_CRUD/admin_patient_delete.php" style="display:inline;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-actions">
                                            ...
                                            <form method="POST" action="http://localhost/project/admin_appoinment_CRUD/admin_appointment_delete.php" style="display:inline;">
    ...
    <div id="addDoctorModal" class="modal">
        <div class="modal-content">
            ...
            <form method="POST" action="http://localhost/project/admin_doctor_CRUD/admin_doctor_create.php" onsubmit="return validateDoctorForm(event)">
    ...
    <div id="editDoctorModal" class="modal">
        <div class="modal-content">
            ...
            <form method="POST" action="http://localhost/project/admin_doctor_CRUD/admin_doctor_update.php">
    ...
    <div id="addPatientModal" class="modal"> 
        <div class="modal-content">
            ...
            <form method="POST" action="http://localhost/project/admin_patient_CRUD/admin_patient_create.php" onsubmit="return validateForm(event)">
                <div class="form-group">
                    <label>First Name</label>
                    <input type="text" name="first_name" placeholder="John" required>
                </div>
    ...
    <div id="editPatientModal" class="modal"> 
        <div class="modal-content">
            ...
            <form method="POST" action="http://localhost/project/admin_patient_CRUD/admin_patient_update.php">
    ...
    <div id="addAppointmentModal" class="modal">
        <div class="modal-content">
            ...
            <form method="POST" action="http://localhost/project/admin_appoinment_CRUD/admin_appointment_create.php" onsubmit="return validateAppointmentForm(event)">
                <div class="form-group">
                    <label>Patient</label>
    ...
    <div id="editAppointmentModal" class="modal">
        <div class="modal-content">
            ...
            <form method="POST" action="http://localhost/project/admin_appoinment_CRUD/admin_appointment_update.php">
